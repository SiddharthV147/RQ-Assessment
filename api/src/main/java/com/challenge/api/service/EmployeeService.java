...
public class EmployeeService {
    ...
    public EmployeeService() {
        Employee e1 = new EmployeeModel(UUID.randomUUID(), "Aniket", "Tote", "Aniket Tote", 70000, 28, "SDE 1", "aniket123@gmail.com", Instant.now(), null);
        Employee e2 = new EmployeeModel(UUID.randomUUID(), "Virat", "Yaduvanshi", "Virat Yaduvanshi", 80000, 30, "SDE 2", "virat123@gmail.com", Instant.now(), null);
    ...
    public Employee fetchById(UUID uuid) {
        ...
        if(employee == null) {
            ...
            throw new ResourceNotFoundException("Employee with UUID does not exists. If there has been any mistake please contact support.");
        }
